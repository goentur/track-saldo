...
function Index({ pemiliks }){
    ...
    const getData = () => {
        setIsLoading(true);
        router.get(route('pemilik.index',pickBy({
    ...
    const hapus = (id) => {
        withReactContent(Swal).fire({
            ...
            if (result.isConfirmed) {
                destroy(route('pemilik.destroy',id))
            }
        })
    }
    return (
        <Layout>
            ...
            <Card>
                <CardHeader className="d-flex justify-content-between align-items-center">
                    ...
                    <Link href={route('pemilik.create')} className="btn btn-primary btn-lg"><FontAwesomeIcon icon={faPlus}/> TAMBAH DATA</Link>
                </CardHeader>
                <CardBody>
                            ...
                            <tr key={pemilik.id}>
                                ...
                                <td>
                                    <ButtonGroup aria-label="button action">
                                        <Link href={route('pemilik.edit',pemilik)} className="btn btn-sm btn-success"><FontAwesomeIcon icon={faEdit}/></Link>
