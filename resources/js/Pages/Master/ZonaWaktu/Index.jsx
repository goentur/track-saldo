...
function Index({ zonaWaktus }){
    ...
    const getData = () => {
        setIsLoading(true);
        router.get(route('master.zona-waktu.index',pickBy({
    ...
    const hapus = (id) => {
        withReactContent(Swal).fire({
            ...
            if (result.isConfirmed) {
                destroy(route('master.zona-waktu.destroy',id))
            }
        })
    }
    return (
        <Layout>
            ...
            <Card>
                <CardHeader className="d-flex justify-content-between align-items-center">
                    <CardTitle><FontAwesomeIcon icon={faClock}/> ZONA WAKTU</CardTitle>
                    <Link href={route('master.zona-waktu.create')} className="btn btn-primary"><FontAwesomeIcon icon={faPlus}/> TAMBAH DATA</Link>
                </CardHeader>
                <CardBody>
                            ...
                            <tr key={zonaWaktu.id}>
                                ...
                                <td>
                                    <ButtonGroup aria-label="button action">
                                        <Link href={route('master.zona-waktu.edit',zonaWaktu)} className="btn btn-sm btn-success"><FontAwesomeIcon icon={faEdit}/></Link>
