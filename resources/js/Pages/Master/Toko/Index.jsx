...
function Index({ tokos }){
    ...
    const getData = () => {
        setIsLoading(true);
        router.get(route('master.toko.index',pickBy({
    ...
    const hapus = (id) => {
        withReactContent(Swal).fire({
            ...
            if (result.isConfirmed) {
                destroy(route('master.toko.destroy',id))
            }
        })
    }
    return (
        <Layout>
            ...
            <Card>
                <CardHeader className="d-flex justify-content-between align-items-center">
                    <CardTitle><FontAwesomeIcon icon={faStore}/> TOKO</CardTitle>
                    <Link href={route('master.toko.create')} className="btn btn-primary"><FontAwesomeIcon icon={faPlus}/> TAMBAH DATA</Link>
                </CardHeader>
                <CardBody>
                            ...
                            <tr key={toko.id}>
                                ...
                                <td>
                                    <ButtonGroup aria-label="button action">
                                        <Link href={route('master.toko.edit',toko)} className="btn btn-sm btn-success"><FontAwesomeIcon icon={faEdit}/></Link>
