...
import Setor from "./Investasi/Setor";
import Tarik from "./Investasi/Tarik";

function InvestasiAnggota({ toko, anggotas, onProcessingDone, showModalAnggota }) {
...
export default InvestasiAnggota;
