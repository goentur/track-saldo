...
function TransferTunai({ toko, anggotas, onProcessingDone, showModalAnggota }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            setLoading(true)
            try {
                const response = await axios.post(route('transaksi.transfer.tunai.simpan'), values);
    ...
    return (
        <Form onSubmit={formik.handleSubmit}>
            <div className="row">
                ...
                <Form.Group className="mb-3 col-lg-4" controlId="validationFormBiayaTransfer">
