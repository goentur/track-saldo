...
function Meminjamkan({ toko, anggotas, tabungans, onProcessingDone }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            setLoading(true)
            try {
                const response = await axios.post(route('transaksi.transfer.pinjam.meminjamkan'), values);
    ...
    return (<>
    <span className="fs-5">FORM MEMINJAMKAN DANA</span>
    <p className="text-info f-14"><FontAwesomeIcon icon={faInfoCircle} /> Form ini digunakan untuk meminjam dana ke anggota.</p>
