...
function TopUp({ toko, anggotas, onProcessingDone, showModalAnggota }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            setLoading(true)
            try {
                const response = await axios.post(route('transaksi.transfer.top-up.simpan'), values);
    ...
    return (
        <Form onSubmit={formik.handleSubmit}>
            <div className="row">
                <Form.Group className="mb-2 col-lg-4" controlId="validationFormNominalBiayaYangDigunakan">
                ...
                <Form.Group className="mb-2 col-lg-4" controlId="validationFormBiayaTransfer">
                    ...
                    <CurrencyInput
                        ...
                        disabled={!formik.values.tabunganYangDigunakan}
                    />
                    <Form.Control.Feedback type="invalid">
