...
use App\Http\Requests\Transaksi\TopUpRequest;
...
class TopUpController extends Controller
{
    ...
    public function simpan(TopUpRequest $request)
    {
        // transfer deatil
        ...
        if ($this->transfer->saveTransfer($transfer, $transferDetail)) {
            ...
            return response()->json(['message' => 'Top Up berhasil disimpan'], 200);
        } else {
